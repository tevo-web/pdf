...
# Needs: pip install fonttools brotli ; npm i @expo-google-fonts/arimo @expo-google-fonts/tinos @expo-google-fonts/cousine @expo-google-fonts/carlito
...
for fam in arimo tinos cousine carlito; do
...
d=sys.argv[1]
fam={'times':'Tinos','helv':'Arimo','calibri':'Carlito','cour':'Cousine'}
